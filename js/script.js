/**
 * Logic for Interactive Gallery with persistent storage (IndexedDB)
 * and floral/heart animations.
 */

class StorageManager {
    constructor() {
        this.dbName = 'HeartGalleryDB';
        this.dbVersion = 3; // Force upgrade to re-create audio store
        this.db = null;
    }
    ...
    async init() {
        return new Promise((resolve, reject) => {
            ...
            request.onupgradeneeded = (event) => {
                ...
                // If audio store exists but needs upgrade to autoIncrement, we recreate it
